...
var format_DataRuns_4 = new ol.format.GeoJSON();
var features_DataRuns_4 = format_DataRuns_4.readFeatures(json_DataRuns_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_DataRuns_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_DataRuns_4.addFeatures(features_DataRuns_4);
var lyr_DataRuns_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_DataRuns_4, 
                style: style_DataRuns_4,
                popuplayertitle: 'Data Runs',
                interactive: true,
    title: 'Data Runs<br />\
    <img src="styles/legend/DataRuns_4_0.png" /> 2.5 - 3.5<br />\
    <img src="styles/legend/DataRuns_4_1.png" /> 3.5 - 4<br />\
    <img src="styles/legend/DataRuns_4_2.png" /> 4 - 4.5<br />\
    <img src="styles/legend/DataRuns_4_3.png" /> 4.5 - 5.5<br />' });
