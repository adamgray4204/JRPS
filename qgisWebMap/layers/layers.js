...
var format_RideDataRun2_2 = new ol.format.GeoJSON();
var features_RideDataRun2_2 = format_RideDataRun2_2.readFeatures(json_RideDataRun2_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RideDataRun2_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RideDataRun2_2.addFeatures(features_RideDataRun2_2);
var lyr_RideDataRun2_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RideDataRun2_2, 
                style: style_RideDataRun2_2,
                popuplayertitle: 'Ride Data Run 2',
                interactive: true,
    title: 'Ride Data Run 2<br />\
    <img src="styles/legend/RideDataRun2_2_0.png" /> 2.5 - 3.5<br />\
    <img src="styles/legend/RideDataRun2_2_1.png" /> 3.5 - 4<br />\
    <img src="styles/legend/RideDataRun2_2_2.png" /> 4 - 4.5<br />\
    <img src="styles/legend/RideDataRun2_2_3.png" /> 4.5 - 5.5<br />' });
var format_RideDataRun1_3 = new ol.format.GeoJSON();
var features_RideDataRun1_3 = format_RideDataRun1_3.readFeatures(json_RideDataRun1_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RideDataRun1_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RideDataRun1_3.addFeatures(features_RideDataRun1_3);
var lyr_RideDataRun1_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RideDataRun1_3, 
                style: style_RideDataRun1_3,
                popuplayertitle: 'Ride Data Run 1',
                interactive: true,
    title: 'Ride Data Run 1<br />\
    <img src="styles/legend/RideDataRun1_3_0.png" /> 2.5 - 3.5<br />\
    <img src="styles/legend/RideDataRun1_3_1.png" /> 3.5 - 4<br />\
    <img src="styles/legend/RideDataRun1_3_2.png" /> 4 - 4.5<br />\
    <img src="styles/legend/RideDataRun1_3_3.png" /> 4.5 - 5.5<br />' });
